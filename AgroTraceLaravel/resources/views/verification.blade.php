    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            <h1 class="text-3xl font-black tracking-tight text-white flex items-center gap-3">
                <i class="fa-solid fa-link text-orange-500"></i> Live On-Chain Ledger
            </h1>
            <p class="text-slate-400 mt-2 font-medium">Immutable agricultural milestones anchored to the Bitcoin network.</p>
        </div>
        <div class="inline-flex items-center gap-2 bg-green-500/20 px-4 py-2 rounded-full border border-green-500/30">
            ...
            <span class="text-xs font-bold text-green-400 uppercase tracking-widest">Network Synced</span>
        </div>
    </div>
</div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead class="bg-slate-50 text-slate-400 text-[10px] uppercase font-black tracking-widest">
                    <tr>
                        <th class="p-6">Date Verified</th>
                        <th class="p-6">Cooperative / Project</th>
                        <th class="p-6">Milestone Reached</th>
                        <th class="p-6 text-right">Bitcoin Anchoring (OP_RETURN)</th>
                    </tr>
                </thead>
