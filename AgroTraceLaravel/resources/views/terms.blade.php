...
<head>
    ...
    <title>Conditions d'utilisation | AgroTrace-BTC</title>
    <!-- Favicon -->
...
<body class="bg-slate-50 text-slate-800 antialiased selection:bg-orange-500 selection:text-white flex flex-col min-h-screen">
    ...
    <main class="flex-1 pt-32 pb-24 relative overflow-hidden">
        <!-- Decor -->
        <div class="absolute top-0 right-0 w-96 h-96 rounded-full bg-orange-100 opacity-50 blur-3xl pointer-events-none"></div>
        <div class="absolute bottom-0 left-0 w-96 h-96 rounded-full bg-green-100 opacity-50 blur-3xl pointer-events-none"></div>

        <div class="relative z-10 bg-white p-8 md:p-12 rounded-[2rem] shadow-xl border border-slate-100 max-w-4xl mx-auto my-10">
    ...
    <div class="prose prose-slate max-w-none space-y-6 text-slate-700">
        ...
        <div class="mt-12 text-center">
            <a href="{{ route('register') }}" class="inline-flex items-center gap-2 bg-[#063b27] text-white px-8 py-4 rounded-full font-bold hover:bg-[#0a4b33] hover:shadow-lg hover:-translate-y-1 transition-all">
