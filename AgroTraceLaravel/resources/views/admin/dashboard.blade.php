...
<div class="bg-slate-900 border-b border-slate-800 px-8 py-10 text-white">
    <div class="flex justify-between items-center">
        <div>
            ...
            <h1 class="text-3xl font-black tracking-tight text-white">Platform Operations</h1>
            <p class="text-slate-400 mt-2 font-medium">Verify projects and anchor milestones to the Bitcoin blockchain.</p>
        </div>
    </div>
</div>
...
<div class="p-8">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden flex flex-col">
            <div class="p-6 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
                <h2 class="text-lg font-bold text-slate-800 flex items-center gap-3">
                    <i class="fa-solid fa-list-check text-orange-500"></i> Project Verification Queue
                </h2>
                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-slate-200 rounded-2xl p-5 hover:border-orange-300 hover:shadow-md transition bg-white group">
                        <div class="flex justify-between items-start mb-3">
                            ...
                            <span class="text-xs font-black text-slate-400 uppercase">{{ number_format($project->budget_fcfa) }} CFA</span>
                        </div>
                        <p class="text-xs text-slate-500 mb-4 font-medium"><i class="fa-solid fa-user mr-1"></i> {{ $project->user->name }} &nbsp;&bull;&nbsp; <i class="fa-solid fa-location-dot mr-1"></i> {{ $project->location }}</p>
                        
                        <div class="flex gap-2">
                            <button class="flex-1 bg-green-50 text-green-700 hover:bg-green-100 font-bold text-xs py-2.5 rounded-xl border border-green-200 transition">
                                Approve
                            </button>
                            <button class="flex-1 bg-red-50 text-red-700 hover:bg-red-100 font-bold text-xs py-2.5 rounded-xl border border-red-200 transition">
                                Reject
                            </button>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 overflow-hidden flex flex-col">
            <div class="p-6 border-b border-slate-50 bg-slate-50/50 flex justify-between items-center">
                <h2 class="text-lg font-bold text-slate-800 flex items-center gap-3">
                    <i class="fa-solid fa-camera text-blue-500"></i> Milestone Proofs
                </h2>
                    ...
                    <div class="border border-slate-200 rounded-2xl p-5 hover:border-blue-300 hover:shadow-md transition bg-white">
                        ...
                        <div class="w-full h-32 bg-slate-100 rounded-xl border border-slate-200 mb-4 flex items-center justify-center text-slate-400">
                            <div class="text-center">
                                ...
                                <p class="text-[10px] font-bold uppercase tracking-widest">Image Proof Attached</p>
                            </div>
                        </div>
                        
                        <button class="w-full bg-[#063b27] hover:bg-[#0a4b33] text-white font-bold text-sm py-3 rounded-xl transition flex justify-center items-center gap-2">
                            <i class="fa-solid fa-link"></i> Validate & Write to Blockchain
                        </button>
                    </div>
                    @endforeach
